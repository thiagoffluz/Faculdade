...
public class GeneralPathCar extends Frame
{
  ...
  public void paint(Graphics g)
  {
    ...
    */
    ...
    /*AffineTransform rotation = AffineTransform.getRotateInstance(600 , 300 , 200 );
    gp.transform(rotation);
    
    AffineTransform translation = AffineTransform.getTranslateInstance(300,300 );
    gp.transform(translation);
    
    GeneralPath gp2 = new GeneralPath();
    
    gp2.moveTo(150,250);//comeco
    gp2.lineTo(165, 310);//linha reta atras
    gp2.lineTo(450, 310);//linha reta de baixo do casco
    gp2.quadTo(480,310,500,250);//curva de baixo casco
    gp2.quadTo(320,260,150,250);//curva de cima do casco
    gp2.moveTo(390,253);
    gp2.lineTo(380, 220);//linha maior da parte superior
    gp2.lineTo(370, 210);//pequena inclinação da parte superior
    gp2.lineTo(220, 210);//teto
    gp2.quadTo(190,210,190,252);//curvatura da parte de tras do teto
    gp2.moveTo(310,210);
    gp2.lineTo(300, 140);//linha inclinada da direita do mastro
    gp2.lineTo(270, 140);//linha reta de cima do mastro
    gp2.lineTo(270, 210);//linha reta de tras do mastro
    /*
    //AVIAO 1
/*
    gp.moveTo(110,100);
...
*/
    ...
    AffineTransform rotation = AffineTransform.getRotateInstance(250 , 300 , 300 );
    gp.transform(rotation);
